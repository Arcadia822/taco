...
- [x] T015 Replace same-origin Blob prototype execution with a bounded opaque-origin document
- [x] T016 Add source/download fallback when isolated execution is unavailable
...
- [ ] T023 Verify prototype origin isolation on hosted HTTP/HTTPS and supported local-file behavior — production attributes and construction passed, but Codex browser policy blocked entry into the `data:` page
