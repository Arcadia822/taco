...
[在线演示（简体中文）](https://taco-spec-zh-cn.arcadia822.chatgpt.site) · [Live demo (English)](https://taco-spec-en.arcadia822.chatgpt.site)

> **让人与 Agent 在一个文件里共同审阅、传递和管理 spec。**
...
![Taco 的规格浏览与评审界面](docs/assets/taco-overview.png)
