...
const en = {
  ...
  language: 'Language', save: 'Save', saved: 'Saved', saveCopy: 'Save a copy…', saveAndUnpack: 'Save & unpack…', copyReview: 'Handoff', copyReviewLabel: 'Handoff', copyAllChanges: 'Handoff', copyTabInspect: 'Handoff (w/o data)', reviewCopied: 'Copied for Agent', noReviewChanges: 'No changes to copy',
  ...
  copyFailed: 'Could not copy review',
  ...
  sourceEditor: (kind: string) => `${kind.toUpperCase()} source editor`, markdownEditor: 'Markdown WYSIWYG editor', editorLoading: 'Loading editor…', editorFailed: 'The editor failed to load.',
  ...
  yourName: 'Your name', nameHint: 'Used for comments', guest: 'Guest', commentName: 'Your name (shown on comments):',
...
const zhHans: Copy = {
  ...
  language: '语言', save: '保存', saved: '已保存', saveCopy: '保存副本…', saveAndUnpack: '解包到文件夹…', copyReview: '交接改动', copyReviewLabel: '交接改动', copyAllChanges: '交接改动', copyTabInspect: '交接改动（不含数据）', reviewCopied: '已复制给 Agent', noReviewChanges: '暂无改动可复制',
  ...
  sourceEditor: (kind: string) => `${kind.toUpperCase()} 源码编辑器`, markdownEditor: 'Markdown 所见即所得编辑器', editorLoading: '正在加载编辑器…', editorFailed: '编辑器加载失败。',
  mermaidLoading: '正在渲染图表…', mermaidError: 'Mermaid 语法有误；请展开源码修正。',
  documentTitle: 'Taco 标题；同时用于浏览器标签和新文件默认名',
  fileTitle: '文件标题；不会修改文件名或路径',
  yourName: '您的名字', nameHint: '用于评论署名', guest: '访客', commentName: '您的名字（显示在评论中）：',
